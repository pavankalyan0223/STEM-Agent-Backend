...
class Generator:
    ...
    def generate_answer(
        ...
        Always uses both local documents and web search (via MCP).
        ...
        # Add search engine agent results (from MCP)
        if search_results.get("status") == "success":
            context_parts.append("=== Web Search Results (via MCP) ===")
            ...
            # Add abstract or processed summary if available (from MCP)
            if search_results.get("abstract"):
                ...
                context_parts.append("=== Web Search Summary (via MCP) ===")
        ...
        system_prompt = (
            ...
            "You have access to local documents and web search results (via MCP). "
...
Provide a comprehensive answer that synthesizes information from all available sources (local documents and web search via MCP). 
